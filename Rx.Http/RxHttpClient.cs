...
namespace Rx.Http
{
    public class RxHttpClient : IDisposable
    {
        ...
        public HttpObservable<string> Get(string path,
        ...
        {
            return CreateGetRequest(path, opts, requestInterceptors, responseInterceptors).Request<string>();
        }

        public HttpObservable<TResponse> Get<TResponse>(string path, 
            Action<RxHttpRequestOptions> opts = null,
            List<RxRequestInterceptor> requestInterceptors = null,
            List<RxResponseInterceptor> responseInterceptors = null)
        ...
        public HttpObservable<TResponse> Post<TResponse>(
            string url, 
            object obj = null, 
        ...
        public HttpObservable<string> Post(
            string url, 
            object obj = null, 
            Action<RxHttpRequestOptions> options = null,
            List<RxRequestInterceptor> requestInterceptors = null,
            List<RxResponseInterceptor> responseInterceptors = null)
        {
            return CreatePostRequest(url, obj, options, requestInterceptors, responseInterceptors).Request<string>();
        }

        public HttpObservable<T> Post<T>(string url, 
            HttpContent form, 
            Action<RxHttpRequestOptions> options = null,
            List<RxRequestInterceptor> requestInterceptors = null,
            List<RxResponseInterceptor> responseInterceptors = null)
        ...
        public HttpObservable<string> Post(string url,
            FormUrlEncodedContent content, 
            Action<RxHttpRequestOptions> options = null,
            List<RxRequestInterceptor> requestInterceptors = null,
            List<RxResponseInterceptor> responseInterceptors = null)
        {
            return CreatePostRequest(url, content, options, requestInterceptors, responseInterceptors).Request<string>();
        }
        ...
        public HttpObservable<TResponse> Put<TResponse>(
            string url, 
            object obj = null, 
            Action<RxHttpRequestOptions> options = null,
            List<RxRequestInterceptor> requestInterceptors = null,
        ...
        public HttpObservable<string> Put(string url, 
            object obj = null, 
            Action<RxHttpRequestOptions> options = null,
            List<RxRequestInterceptor> requestInterceptors = null,
            List<RxResponseInterceptor> responseInterceptors = null)
        {
            return CreatePutRequest(url, obj, options, requestInterceptors, responseInterceptors).Request<string>();
        }

        public HttpObservable<T> Put<T>(string url, 
        ...
        public HttpObservable<string> Put(string url, 
            ...
            List<RxResponseInterceptor> responseInterceptors = null)
        {
            return CreatePutRequest(url, content, options, requestInterceptors, responseInterceptors).Request<string>();
        }
        ...
        public HttpObservable<TResponse> Delete<TResponse>(string url, 
            Action<RxHttpRequestOptions> options = null,
            List<RxRequestInterceptor> requestInterceptors = null,
            List<RxResponseInterceptor> responseInterceptors = null) where TResponse : class
        {
        ...
        public HttpObservable<string> Delete(string url, 
            Action<RxHttpRequestOptions> options = null,
            List<RxRequestInterceptor> requestInterceptors = null,
            List<RxResponseInterceptor> responseInterceptors = null)
        {
            return CreateDeleteRequest(url, options, requestInterceptors, responseInterceptors).Request<string>();
        }
